...
def generate_unroll(actor_step, planner_step,
...
class CrlEvaluator:
    ...
    def __init__(self, actor_step, planner_step, eval_env, num_eval_envs, episode_length, key):
    ...
    def run_evaluation(self, training_state, planning_state, training_metrics, aggregate_episodes=True):
        """Run one epoch of evaluation."""
        self._key, unroll_key = jax.random.split(self._key)

        t = time.time()
        eval_state, planning_state, _ = self._generate_eval_unroll(
            training_state, planning_state, unroll_key)
