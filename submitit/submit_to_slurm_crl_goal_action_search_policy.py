                                ...
                                for quasimetric_energy_type in ["none"]:
                                    for repr_dim in [64]:
                                        for total_env_steps in [10_000_000]:
                                            for seed in [0]:
                                                exp_name = f"phi_sa_psi_phi_gag_sg_forward_infonce_planner={train_planner}_{eval_planner}_max_edge_dist={max_edge_dist}_{resubs}_quasimetric={quasimetric_energy_type}_repr_dim={repr_dim}_{log1msoftmax}"
